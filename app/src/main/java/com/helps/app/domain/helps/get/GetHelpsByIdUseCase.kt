...
class GetHelpsByIdUseCase @Inject constructor(
    ...
    suspend operator fun invoke(id: String): Result = withContext(Dispatchers.Default) {
        return@withContext when (val result = getHelpsAPI.getById(id)) {
